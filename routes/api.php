...
Route::middleware(['tenant'])->group(function () {
    ...
    Route::prefix('posts')->group(function () {
        ...
        Route::get('/{postId}/student/{studentId}', 'PostController@show');

        Route::post('/{postId}/student/{studentId}/read', 'PostController@markAsRead');
    ...
    Route::prefix('app-familias')->namespace('AppFamilias')->group(function () {
        ...
        Route::get('/walls/{wallId}/student/{studentId}', 'FamilyWallController@show');
        Route::post('/walls/{wallId}/student/{studentId}/intervenir', 'FamilyWallController@storeIntervention');
        ...
        // COMUNICADOS / POSTS
        Route::get('/posts/student/{studentId}', 'FamilyPostController@index');
        Route::get('/posts/{postId}/student/{studentId}', 'FamilyPostController@show');
        ...
        Route::get('/students/{studentId}/aulas', 'FamilyAulaController@index');
        Route::get('/students/{studentId}/aulas/{materiaId}/tipo/{tipoMateria}', 'FamilyAulaController@show');
        Route::get('/students/{studentId}/aulas/{materiaId}/tipo/{tipoMateria}/tareas', 'FamilyAulaController@tareas');
        Route::get('/students/{studentId}/aulas/{materiaId}/tipo/{tipoMateria}/recursos', 'FamilyAulaController@recursos');

        // TAREAS VIRTUALES
        Route::prefix('v1/families')->group(function () {
            // Listado de tareas
            Route::get('students/{studentId}/tasks', 'FamilyTaskController@index');
            
            // Ver detalle de una tarea específica
            Route::get('students/{studentId}/tasks/{taskId}', 'FamilyTaskController@show');
            
            // Acciones sobre una tarea
            Route::post('students/{studentId}/tasks/{taskId}/resolutions', 'FamilyTaskController@storeResolution');
            Route::post('students/{studentId}/tasks/{taskId}/queries', 'FamilyTaskController@storeQuery');
            
            // AULAS VIRTUALES NIVEL SUPERIOR
            Route::get('students/{studentId}/aulas-superior', 'FamilyAulaController@index');
        });
